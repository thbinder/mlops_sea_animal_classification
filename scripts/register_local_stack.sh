...
pdm run zenml stack register local_stack -o local_orchestrator -e mlflow_experiment_tracker -dv evidently_validator -d mlflow_deployer -a minio_store -x vault_sm
